...
def move_rename(
    ...
    *,
    ...
    # dest on disk -v      |              |             |
    # -------------------- | ------------ | ----------- | -----------
    # file exists          | err          | getfreename | getfreename
    # directory exists     | joinpath     | getfreename | joinpath
...
def main():
    ...
    args = parse_args()
    dest_as_directory = False if args.no_target_directory else None
    ...
    for item in args.source:
        try:
            move_rename(
                item,
                args.dest,
                dest_as_directory=dest_as_directory,
                dryrun=args.dry_run,
            )
